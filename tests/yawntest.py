...
class TestYawnDetection(unittest.TestCase):
    ...
    def test_yawn_detected(self):
        ...
        self.assertTrue(self.detect_yawn("test_images/yawn2.jpg"))
        self.assertTrue(self.detect_yawn("test_images/yawn3.jpg"))
        self.assertTrue(self.detect_yawn("test_images/yawn4.jpg"))
        self.assertTrue(self.detect_yawn("test_images/yawn5.jpg"))

    def test_no_yawn_detected(self):
        self.assertFalse(self.detect_yawn("test_images/nsmk1.jpg"))
        self.assertFalse(self.detect_yawn("test_images/nsmk2.jpg"))
        self.assertFalse(self.detect_yawn("test_images/nsmk3.jpg"))
        self.assertFalse(self.detect_yawn("test_images/nsmk4.jpg"))
        self.assertFalse(self.detect_yawn("test_images/nsmk5.jpg"))
